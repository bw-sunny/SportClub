namespace FitnessClub
{
	partial class AdminVisitForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.dateTimePicker1.Location = new System.Drawing.Point(213, 80);
			...
			this.dateTimePicker2.Location = new System.Drawing.Point(213, 121);
			...
			// button1
			// 
			this.button1.Location = new System.Drawing.Point(213, 159);
			this.button1.Name = "button1";
			this.button1.Size = new System.Drawing.Size(254, 57);
			this.button1.TabIndex = 3;
			this.button1.Text = "Найти записанных клиентов";
			...
			this.button2.Text = "Отметить всех доступных клиентов";
			...
			this.label4.Text = "Статус: готово";
			// 
			// AdminVisitForm
			// 
			...
			this.Name = "AdminVisitForm";
			this.Text = "Отметка посещений";
