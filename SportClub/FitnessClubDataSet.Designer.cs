...
namespace SportClub.FitnessClubDataSetTableAdapters {
...
SELECT ID_Клиента, ФИО, Номер_телефона, Дата_рождения FROM Клиенты WHERE (ID_Клиента = @ID_Клиента)";
        ...
        public virtual int Fill(FitnessClubDataSet.КлиентыDataTable dataTable) {
        ...
        public virtual FitnessClubDataSet.КлиентыDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            FitnessClubDataSet.КлиентыDataTable dataTable = new FitnessClubDataSet.КлиентыDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(FitnessClubDataSet.КлиентыDataTable dataTable) {
