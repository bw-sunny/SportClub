namespace SportClub
{
    partial class AdminEnrollsNew
    {
        ...
        private void InitializeComponent()
        {
			...
			this.fitnessClubDataSet5BindingSource = new System.Windows.Forms.BindingSource(this.components);
			...
			((System.ComponentModel.ISupportInitialize)(this.fitnessClubDataSet5BindingSource)).BeginInit();
			this.SuspendLayout();
			// 
			// fitnessClubDataSet5
			// 
			...
			// 
			// fitnessClubDataSet5BindingSource
			// 
			this.fitnessClubDataSet5BindingSource.DataSource = this.fitnessClubDataSet5;
			this.fitnessClubDataSet5BindingSource.Position = 0;
			// 
			// textBox1
			// 
			...
			this.dateTimePicker1.Location = new System.Drawing.Point(300, 175);
			...
			this.button2.Location = new System.Drawing.Point(340, 246);
			...
			this.Name = "AdminEnrollsNew";
			this.Text = "AdminEnrollsNew";
			this.Load += new System.EventHandler(this.AdminEnrollsNew_Load);
			((System.ComponentModel.ISupportInitialize)(this.fitnessClubDataSet5)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.fitnessClubDataSet5BindingSource)).EndInit();
        ...
        #endregion
        private System.Windows.Forms.BindingSource fitnessClubDataSet5BindingSource;
